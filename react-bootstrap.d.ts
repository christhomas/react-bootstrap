...
declare module "react-bootstrap" {
  ...
  interface ModalHeaderProps extends React.Props<ModalHeaderClass> {
    ...
    // <Breadcrumb />
   // ----------------------------------------
   interface BreadcrumbProps extends React.Props<BreadcrumbClass> {
       className?: string;
   }
   ...
   // <BreadcrumbItem />
   // ----------------------------------------
   interface BreadcrumbItemProps extends React.Props<BreadcrumbItemClass> {
       className?: string;
       href?: string;
       title?: string;
   active?: boolean;
   ...
   // <Image />
   // ----------------------------------------
   interface ImageProps extends React.Props<ButtonClass> {
